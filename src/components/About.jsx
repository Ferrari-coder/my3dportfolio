...
const ServiceCard = ({ index, title, icon }) => {
  return (
    <Tilt className="xs:w-[250px] w-full">
      <motion.div
        // fades from the right , then evry index starting from 0 multiply by 0.5 till it gets to 0.75
...
const About = () => {
  return (
    <>
      ...
      >
        I'm a skilled Front-end engineer with experience in TypeScript and
